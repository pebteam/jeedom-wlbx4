...
Pour créer un équipement, cliquez sur  ![Alt](/BLs.png)Ajouter#1![Alt](/BRs.png)  puis donnez lui un nom (Dans la suite du présent document, la référence au nom donné sera [Livebox]).     

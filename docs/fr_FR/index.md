...
Pour créer un équipement, cliquez sur  :black_square_button: Ajouter puis donnez lui un nom (Dans la suite du présent document, la référence au nom donné sera [Livebox]).     

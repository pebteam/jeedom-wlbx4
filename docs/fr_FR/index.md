...
Pour créer un équipement, cliquez sur [Ajouter] (http://192.168.1.1) puis donnez lui un nom (Dans la suite du présent document, la référence au nom donné sera [Livebox]).     

...
Pour créer un équipement, cliquez sur ![Alt](/BL.png) Ajouter ![Alt](/BR.png) puis donnez lui un nom (Dans la suite du présent document, la référence au nom donné sera [Livebox]).     

...
Pour créer un équipement, cliquez sur  :white_medium_small_square: Ajouter puis donnez lui un nom (Dans la suite du présent document, la référence au nom donné sera [Livebox]).     
